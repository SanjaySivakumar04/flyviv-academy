    ...
    $(document).ready(function() {
        $('.image-popup-gallery').magnificPopup({
            ...
            gallery: {
                ...
                navigateByImgClick: true, // Allows navigation by clicking on the image
                preload: [0,1] // Preloads the next and previous images
            },
            image: {
                titleSrc: 'title' // Displays the title of the image
            }
        });
    });
    /*--------------------------
